...
export const initiateAdmin = async (req: Request, res: Response): Promise<void> => { 
   try {
        ...
        const salt = await bcrypt.genSalt (10); //misalnya password = "admin123" maka akan terencripsi menjadi "sdfj3r8sdfj3r8sdfj3r8sdfj3r8sdfj3r8sdfj3r8sdfj3r8sdfj3r8"
        ...
        //untuk menyimpan data user baru ke database
        await newUser.save();
